 ...
 * </p>
 * <ul>
 *   <li>{@link screenModel.impl.AttributImpl#getName <em>Name</em>}</li>
 *   <li>{@link screenModel.impl.AttributImpl#getDatentyp <em>Datentyp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AttributImpl extends MinimalEObjectImpl.Container implements Attribut {
	...
	protected EClass eStaticClass() {
		return ScreenModelPackage.Literals.ATTRIBUT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScreenModelPackage.ATTRIBUT__NAME, oldName, name));
	}
	...
	public void setDatentyp(String newDatentyp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ScreenModelPackage.ATTRIBUT__DATENTYP, oldDatentyp, datentyp));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ScreenModelPackage.ATTRIBUT__NAME:
				return getName();
			case ScreenModelPackage.ATTRIBUT__DATENTYP:
				return getDatentyp();
		}
