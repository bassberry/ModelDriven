...
/**
 * This is the item provider adapter for a {@link workflowModel.Workflow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkflowItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowModelPackage.Literals.WORKFLOW__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WorkflowModelPackage.Literals.WORKFLOW__ZUSTAND);
			childrenFeatures.add(WorkflowModelPackage.Literals.WORKFLOW__DATENOBJEKT);
			childrenFeatures.add(WorkflowModelPackage.Literals.WORKFLOW__DATENSTRUKTUR);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WorkflowModelPackage.Literals.WORKFLOW__ZUSTAND,
				 WorkflowModelFactory.eINSTANCE.createZustand()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowModelPackage.Literals.WORKFLOW__DATENOBJEKT,
				 WorkflowModelFactory.eINSTANCE.createDatenobjekt()));

		newChildDescriptors.add
			(createChildParameter
				(WorkflowModelPackage.Literals.WORKFLOW__DATENSTRUKTUR,
				 WorkflowModelFactory.eINSTANCE.createDatenstruktur()));
	}
