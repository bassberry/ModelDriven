...
/**
 * This is the item provider adapter for a {@link screenModel.Button} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ButtonItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Button_seite_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Button_seite_feature", "_UI_Button_type"),
				 ScreenModelPackage.Literals.BUTTON__SEITE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addDisplayTextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Button_displayText_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Button_displayText_feature", "_UI_Button_type"),
				 ScreenModelPackage.Literals.BUTTON__DISPLAY_TEXT,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Button)object).getDisplayText();
